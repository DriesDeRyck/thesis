...
correlation_df = pd.read_csv("../data/soil/correlation_filtered.tsv", sep='\t', index_col=0)
...
microbes_normalized = pd.read_csv("../data/soil/microbes_normalized.tsv", sep='\t', index_col=0)
metabolites_normalized = pd.read_csv("../data/soil/metabolites_normalized.tsv", sep='\t', index_col=0)
...
highest_correlations = pd.read_csv("../data/soil/highest_correlations.tsv", sep='\t', index_col=0)
microbes_df = pd.read_csv("../data/soil/microbes_normalized.tsv", sep='\t', index_col=0).T
metabolites_df = pd.read_csv("../data/soil/metabolites_normalized.tsv", sep='\t', index_col=0).T
