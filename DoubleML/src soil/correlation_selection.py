...
correlation_df = pd.read_csv("../data/soil/correlation_matrix.tsv", sep='\t', index_col=0)
pvalues_df = pd.read_csv("../data/soil/correlation_pvalues.tsv", sep='\t', index_col=0)
#%%
...
# save selection
correlation_df.to_csv("../data/soil/correlation_filtered.tsv", sep='\t', index=True)
